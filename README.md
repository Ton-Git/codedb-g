...
> - **Language support** — Zig, Python, TypeScript/JavaScript, Rust, PHP, Java (more planned)
...
- **Explorer** — structural index engine. Parses Zig, Python, TypeScript/JavaScript, Rust, PHP, and Java. Maintains outlines, trigram index, inverted word index, content cache, and dependency graph behind a single mutex.
