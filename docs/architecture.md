...
**Language parsers:** Zig, Python, TypeScript/JavaScript, Rust, PHP, and Java. Each parser extracts functions, classes/structs, constants, imports, and test declarations from source lines.
